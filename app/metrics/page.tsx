  ...
  return (
    <main className="ds-data ds-wrap ds-view">
      ...
      <p className="ds-lead plain">
        ...
        public demo report contains. Each number is either derived from the committed source it lives
        in, or pinned to a fixed version and checked against that source.
      </p>
      ...
      <section>
        ...
        <p className="ds-runline" style={{ maxWidth: "78ch" }}>
          ...
          <span className="ds-mono">{ENGINE.ucpSpecVersion}</span>), fetched verbatim, pinned to a
          fixed version, and validated against — never edited. The headline the engine demonstrates: a
      ...
      <section>
        <h2 className="ds-h2-row">The demo report</h2>
        <p className="ds-runline" style={{ maxWidth: "78ch" }}>
