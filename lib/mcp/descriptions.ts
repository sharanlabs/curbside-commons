 ...
 * server advertises for each of the A0 registry's six tools (plan
 * `docs/plan-agentic-extension.md` §5 row A1). Kept as its own small module
 ...
 *
 * Plain: the little labeled sticker on each of the six buttons, so a person
