    ...
    statements: {
      ...
      "statement.drifted.json": {
        entries: [
          ...
          { id: "fee-drift-002", feeClass: "processing-fee-base-inflation", detection: "deterministic", expectedClaimId: "ORD-1#transaction_fee", expectedRuleId: "NYC-563.3-c-1", expectedVerdict: "violation", targetOrderId: "ORD-1", note: "transaction fee 8% > hard 3% cap, not documented as a pass-through (c-2); no safe harbor for c" },
          { id: "fee-drift-003", feeClass: "bundling", detection: "deterministic", expectedClaimId: "ORD-3#service_and_delivery", expectedRuleId: "NYC-563.3-d-1", expectedVerdict: "violation", targetOrderId: "ORD-3", note: "a lumped line under a non-permitted category label — caught by the d-1 category lock" },
          { id: "fee-drift-004", feeClass: "promotion-deduction-mischaracterization", detection: "deterministic", expectedClaimId: "ORD-4#promotion_deduction", expectedRuleId: "NYC-563.3-d-1", expectedVerdict: "violation", targetOrderId: "ORD-4", note: "a charge dressed as a 'promotion deduction' is not a permitted fee category — d-1" },
