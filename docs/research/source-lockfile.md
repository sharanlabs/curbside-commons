...
| L6 | Official `ucp-schema` version (v1.4.0 as of 2026-07-02) | **PENDING-RELOCK** | Council correction 2026-07-02; version moves — re-check the repo release at W2 (CI oracle pin) and before public claims |
