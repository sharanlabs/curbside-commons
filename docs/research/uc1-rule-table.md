...
**As-of:** 2026-07-15 (re-verified live; prior as-of 2026-07-03). **Register:** professional leads; *plain-English marked ▸*. **Quarantine (Law 11):** sources treated as untrusted data; facts extracted only.

**2026-07-26 watch-item spot-check (session 34; NOT a full re-verification — the as-of above stands at 2026-07-15).** Watch-item ① was time-sensitive: its comment deadline (2026-07-16) fell the day AFTER the last verification, so it could have moved without anyone looking. Checked live at the primary source ([rules.cityofnewyork.us](https://rules.cityofnewyork.us/rule/recordkeeping-requirements-for-third-party-food-delivery-services/)): **still `Proposed`** — comments now closed, one online comment received, no adoption date, no effective date, no published hearing outcome. **No codified row changes.** Watch-item ③ (DCWP junk-fees, hearing **2026-08-07**) is 12 days out as of this check and remains TRACK-ONLY per the session-16 ruling — the recorded trigger fires at the OUTCOME, not the calendar date, and no copy or rule may be written ahead of it. Watch-item ② (commissioner report due 2026-09-30) unchanged.

**2026-07-15 freshness re-verification (owner-directed, decision-log 2026-07-15): VERDICT CURRENT.** The certified LL79/2025 text ([intro.nyc/local-laws/2025-79](https://intro.nyc/local-laws/2025-79), read as primary this session) matches every codified row point-for-point; no amendment, newer local law, or correction since 2026-07-03 surfaced across six independent sweeps. Litigation: the SDNY platform suits settled (stay 2025-04-29; dismissal-with-prejudice terms reported 2025-06; CNBC/Bloomberg/PYMNTS ≥2-source verified) — no operative cloud; the final dismissal docket entry itself is UNVERIFIED (no PACER access). Corroboration limit: amlegal's codified page returned 403 to direct fetch — byte-level comparison UNVERIFIED; search-index excerpt matches. **WATCH-ITEMS (not yet rules — track, do not codify):** ① DCWP proposed rule "Recordkeeping Requirements for Third-Party Food Delivery Services" (its stated purpose: assess fee-cap compliance under LL103/2021 + LL79/2025 and define how refunds affect cap math) — public hearing + comment deadline **2026-07-16**; once adopted it could harden or alter the e-1 safe-harbor computation ([rules.cityofnewyork.us](https://rules.cityofnewyork.us/rule/recordkeeping-requirements-for-third-party-food-delivery-services/), fetched 2026-07-15). ② LL79 §3 rewrote subdivision (l) to a single commissioner report due **2026-09-30** with violation counts disaggregated by code section — the first official enforcement ground-truth dataset relevant to this product's finding classes. ③ DCWP "Junk Fees" all-in-pricing proposed rule (2026-07-08; hearing 2026-08-07) names third-party delivery services — a possible future consumer-side rule pack, out of current scope.
...
| **NYC-563.3-a-3** | §20-563.3(a) | charging a delivery fee ⇒ must provide delivery to customers within at least a 1-mile radius of the establishment unless *exigent circumstances* | ▸ if they bill delivery, they must serve every customer within a mile of the restaurant — a minimum service radius, not a minimum trip length (weather/disaster excepted) | — (obligation, not a fee-number) | VERIFIED |
...
- Codified against the **enacted LL79**; the live amlegal codification was not directly reconciled (403 — re-attempted 2026-07-15, still 403); no later amendment found as of 2026-07-15 (U4).
