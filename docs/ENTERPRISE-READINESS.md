...
- **Quality gate** — `npm run verify` (typecheck · lint · test · build); 161 tests + 3 Playwright e2e including the differential + the guardrail-corpus + draft-text differentials; `next build` prerenders every route (also the console render-smoke).
